...
def plot_figure13_paper(log_path):
    ...
    plt.subplots_adjust(wspace=wspace, hspace=hspace)  # 设置两个子图之间的宽度间距
    ...
    # current_path = '/mnt/wencong.xwc/sunbiao/develop/vllm/benchmarks-repo/'
    # fig_filename = os.path.join(current_path, "evaluation2.pdf")
