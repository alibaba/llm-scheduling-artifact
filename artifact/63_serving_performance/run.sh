...
# Estimated Time of this script: 40h
# 128-128: 3.5h, 256-256: 7h, 512-512: 14h, 128-512: 11.5h, 512-128: 3.5h


# 128-128
# 32.0 33.0 34.0 35.0 36.0 37.0 38.0
# 7x3=21 commands, 10min per command, 3.5h in total

bash ./llumnix_exp ./config/serving_exp 32.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 33.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 34.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 35.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 36.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 37.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
...
bash ./llumnix_exp ./config/serving_exp 38.0 poisson 1.0 128 128 balanced 0 0 3 '128_128/Round_Robin'
